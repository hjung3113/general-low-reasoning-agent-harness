...
| Target release smoke matrix | PASS | `python3 scripts/release_smoke_test.py` covers core, OpenCode, Roo, both, python-analysis, dotnet-etl, web, workflow-quality, and all-packs install/check/target-smoke cases. Latest temp matrix: `/var/folders/6t/ddmgth_n47j1dq_mwk8lm6700000gn/T/harness-release-smoke.9v9_tr7r`. |
