...
7. Record the decision.
   ...
   - If the ADR adds, deletes, inserts, renumbers, completes, or reopens a roadmap phase, update `.planning/ROADMAP.md`, `.planning/STATE.md`, and the active phase `*-CHECKPOINTS.md` together. Advance the live gate via `harness phase set <X>` (and `phase approve` if entering execute); do NOT direct-edit `.scratch/phase-state.json`.
